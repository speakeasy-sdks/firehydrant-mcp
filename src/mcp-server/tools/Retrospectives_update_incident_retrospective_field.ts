...
import { Retrospectives_update_incident_retrospective_field } from "../../funcs/Retrospectives_update_incident_retrospective_field.js";
...
export const tool$Retrospectives_update_incident_retrospective_field:
...
`,
    ...
    tool: async (client, args, ctx) => {
      const [result, apiCall] =
        await Retrospectives_update_incident_retrospective_field(
          client,
          args.request,
